...
import { Megaphone, Plus, Search, Trash2, Edit3, Calendar, User, Clock, AlertCircle } from 'lucide-react';
...
export default function AnnouncementsPage() {
    ...
    const filtered = announcements.filter((ann) => {
        const matchesPriority = priorityFilter === 'all' || ann.priority?.toLowerCase() === priorityFilter.toLowerCase();
        const matchesSearch =
        ...
        <div className="space-y-6 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                        Real-time updates, rescheduling notices, and university circulars.
                    </p>
                </div>
                <button
            ...
            {isLoading ? (
                ...
                <div className="p-8 text-center text-red-500 glass rounded-2xl">
                    ...
                    Failed to load announcements. Please check connection.
                </div>
            ) : filtered.length === 0 ? (
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4">
                    <div className="glass bg-white/95 max-w-lg w-full rounded-2xl p-6 shadow-2xl border border-white">
                ...
                <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4">
                    <div className="glass bg-white max-w-sm w-full rounded-2xl p-6 text-center shadow-xl">
                        ...
                        <p className="text-sm text-gray-500 mt-1 mb-5">
                            This notice will be removed immediately from both the dashboard and the AI agent's knowledge base.
                        </p>
